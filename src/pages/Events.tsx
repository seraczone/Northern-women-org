...
//               </div>
//             </div>
//             <Button variant="gold" size="xl" onClick={() => navigate("/get-involved")}>
//               Register Now <ArrowRight size={18} />
//             </Button>
//           </div>
//         </div>
...
// // Northern Women Summit — ALL 55 IMAGES
...
//                         {p.description}
//                       </p>
//                       <Button variant="burgundy" onClick={() => navigate("/donate")}>
//                         Donate
//                       </Button>
//                     </motion.div>
//                   )}
