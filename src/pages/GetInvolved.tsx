...
//             </h1>
//             <p className="text-lg text-primary-foreground/90">
//               Join Northern Women Initiative and use your skills to empower women and communities.
//             </p>
//           </div>
//         </div>
//       </section>
...
//                   <Textarea
//                     rows={4}
//                     placeholder="Tell us about your skills, experience, and availability..."
//                   />
//                 </div>
...
//           </h2>
//           <p className="text-lg text-muted-foreground mb-8 max-w-2xl mx-auto">
//             We'd love to hear from you. Reach out and let's discuss how you can get involved.
//           </p>
//           <Button variant="burgundy" size="lg" asChild>
//             <a href="/contact">
//               Contact Us
